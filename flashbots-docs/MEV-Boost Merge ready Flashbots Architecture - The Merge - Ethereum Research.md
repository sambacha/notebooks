...
-   **builder**: party specialized in the construction of ethereum
...
On the validator side, this architecture makes use of an independent
...
The current design requires the following modifications to the consensus
client interface:
